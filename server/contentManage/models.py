...
class Page(models.Model):
    ...
    class Meta:
        permissions = (("is_admin", "User is an admin"),)
...
class Image(models.Model):
    ...
    parent_component = models.ForeignKey(
        Component, on_delete=models.CASCADE, related_name="image_field"
    )
...
class Text(models.Model):
    parent_component = models.ForeignKey(
        Component, on_delete=models.CASCADE, related_name="text_field"
    )
