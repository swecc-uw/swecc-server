...
urlpatterns = [
    ...
    path('topics/<uuid:topic_id>/', views.QuestionTopicUpdateView.as_view(), name='topic-update'),
    ...
    path('<str:type>/queue/', views.QuestionQueueUpdateView.as_view(), name='question_queue'),
]